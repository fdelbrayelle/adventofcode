...
func TestMarkBoards(t *testing.T) {
	...
	// When
	var actualBoards []Board = markBoards(initialBoards, numbers)
...
func TestCheckBoardsInRow(t *testing.T) {
	...
	// When
	var actualCheckBoardsResult bool = checkBoards(markedBoards)
...
func TestLoopGame(t *testing.T) {
	...
	// When
	var actualLoopGameResult bool = loopGame(initialBoards, numbers)

	// Then
	if !actualLoopGameResult {
		t.Errorf("There should have a winner!")
	}
}
